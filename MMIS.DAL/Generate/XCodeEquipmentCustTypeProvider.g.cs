...
namespace MMIS.DAL
{
    ...
    /// 单位类型
    /// </summary>
    public partial class XCodeEquipmentCustTypeProvider : XProviderBase
    {
        ...
        {
            XCodeEquipmentCustTypeInfo info = modelInfo as XCodeEquipmentCustTypeInfo;
