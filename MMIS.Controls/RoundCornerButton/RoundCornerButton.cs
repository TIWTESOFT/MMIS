...
namespace MMIS.Controls
{
    ...
    public class RoundCornerButton : Button
    {
        ...
        {
            base.OnGotFocus(e);
            ControlState = MMIS.Controls.ControlState.Focused;
        }

        protected override void OnLostFocus(EventArgs e)
        {
            base.OnLostFocus(e);
            ControlState = MMIS.Controls.ControlState.Normal;
        }
            ...
            if (Enabled)
            {
                switch (ControlState)
                {
                    ...
                    case ControlState.Pressed:
                        ...
                        borderColor = _baseColor;
                        break;
                    case MMIS.Controls.ControlState.Focused:
                        baseColor = GetColor(_baseColor, 0, -45, -24, -12);
                        borderColor = _baseColor;
                        break;
                    default:
