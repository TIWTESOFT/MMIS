...
namespace MMIS.Helper
{
    public class XFtpTool
    {
        ...
        public XFtpTool(string ftpServerIP, string ftpUserID, string ftpPassword)
        {
        ...
        public void Upload(string uploadFileName, string newFileName) //上面的代码实现了从ftp服务器上载文件的功能
        {
            FileInfo fileInf = new FileInfo(uploadFileName);
            // string uri = "ftp://" + ftpServerIP + "/" + fileInf.Name;
            string uri = "ftp://" + ftpServerIP + "/" + newFileName;
            Connect(uri);//连接         
            // 默认为true，连接不会被关闭
            // 在一个命令之后被执行
            ...
            {
                MessageBox.Show(ex.Message, "保存文件失败!");
            }
        }
