...
namespace MMIS.BLL
{
    ...
    /// 任务附件
    /// </summary>
    public partial class XTaskAttachmentBusiness : XBusinessBase
    {
        public XTaskAttachmentBusiness()
        {
            this.m_Provider = XFactoryManager.CreateFactory().GetTaskAttachmentProvider();
        }
