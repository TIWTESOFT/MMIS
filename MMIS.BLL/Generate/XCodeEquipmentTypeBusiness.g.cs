...
namespace MMIS.BLL
{
    ...
    /// 设备类型
    /// </summary>
    public partial class XCodeEquipmentTypeBusiness : XBusinessBase
    {
        public XCodeEquipmentTypeBusiness()
        {
            this.m_Provider = XFactoryManager.CreateFactory().GetCodeEquipmentTypeProvider();
        }
