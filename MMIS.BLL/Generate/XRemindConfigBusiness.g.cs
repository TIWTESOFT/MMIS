...
namespace MMIS.BLL
{
    ...
    /// 提醒设置
    /// </summary>
    public partial class XRemindConfigBusiness : XBusinessBase
    {
        public XRemindConfigBusiness()
        {
            this.m_Provider = XFactoryManager.CreateFactory().GetRemindConfigProvider();
        }
