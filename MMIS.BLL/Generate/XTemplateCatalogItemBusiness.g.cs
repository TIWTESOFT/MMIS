...
namespace MMIS.BLL
{
    ...
    /// 
    /// </summary>
    public partial class XTemplateCatalogItemBusiness : XBusinessBase
    {
        public XTemplateCatalogItemBusiness()
        {
            this.m_Provider = XFactoryManager.CreateFactory().GetTemplateCatalogItemProvider();
        }
