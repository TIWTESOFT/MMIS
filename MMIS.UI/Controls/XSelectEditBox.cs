...
namespace MMIS.UI
{
    public partial class XSelectEditBox : XQueryEditBox, IXAllowEmptyAble
    {
        public XSelectEditBox()
        {
        ...
        {
            frmListBase frm = this.GetSelectForm();
            if (frm != null)
            {
        ...
        protected virtual frmListBase GetSelectForm()
        {
            return null;
        }
